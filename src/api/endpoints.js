...
export const endpoints = {
  ...
  news: (query, signal) => get('/news', query, signal),
  newsTokens: signal => get('/news/tokens', null, signal),
  newsImages: signal => get('/news/images', null, signal),
  updateNewsImage: (context, body, signal) => apiClient.put(`/news/images/${context}`, body, { actor: 'web', signal }),
  ...
  teamCovers: (teamId, signal) => get(`/teams/${teamId}/covers`, null, signal),
  addTeamCover: (teamId, body, signal) => apiClient.post(`/teams/${teamId}/covers`, body, { actor: 'web', signal }),
  removeTeamCover: (teamId, coverId, signal) => apiClient.delete(`/teams/${teamId}/covers/${coverId}`, {}, { actor: 'web', signal }),
  addTeamTitle: (teamId, body, signal) => apiClient.post(`/teams/${teamId}/titles`, body, { actor: 'web', signal }),
  removeTeamTitle: (teamId, titleId, signal) => apiClient.delete(`/teams/${teamId}/titles/${titleId}`, {}, { actor: 'web', signal }),
  ...
  swapSquadMembers: (teamId, starterPlayerId, substitutePlayerId, signal) => apiClient.post(`/teams/${teamId}/squad/swap`, { starterPlayerId, substitutePlayerId }, { actor: 'web', signal }),
  ...
  createPlayoffs: (tournamentId, body, signal) => apiClient.post(`/tournaments/${tournamentId}/playoffs`, body, { actor: 'web', signal }),
  resolvePlayoffTiebreak: (seriesId, winnerTeamId, signal) => apiClient.post(`/playoff-series/${seriesId}/tiebreak`, { winnerTeamId }, { actor: 'web', signal }),
